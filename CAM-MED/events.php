...
<div id="container"><img src="images/header.jpg" width="972" height="174" border="0" usemap="#Map" />
	...
	<table id="content" cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			<td><!-- InstanceBeginEditable name="MainContent" --><img src="images/gen_amb.jpg" width="703" height="287" /> <img src="images/eventsbanner.jpg" width="703" height="43" />
				<h2>EMS Events</h2>
				<div class="lined">
					<div id="events"> <?php echo $longEvents; ?> </div>
				</div>
			...
			//-->
				...
				<noscript>
				<!-- InstanceBeginEditable name="DefaultTestimonial" --><img src="images/testimonials/t5.jpg" width="268" /><!-- InstanceEndEditable -->
				</noscript>
				<br />
				<!-- InstanceBeginEditable name="RightColumn" -->
				<div id="sidebar_factsheet" style="margin-top:15px;">
